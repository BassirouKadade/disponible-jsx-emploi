...
export default function Module({ etat }) {
            ...
            {!openMenu && (
              <>
                ...
                <nav className="salles-menu">
                  <ul>
                    <li>
                      <Link to="ajoutModule" className={select === 1 && "aSelect"} onClick={() => setSelect(1)}>
                        <FontAwesomeIcon icon={faPlusCircle} /> Ajout des Modules
                      </Link>
                    </li>
                    <li>
                      <Link to="listeModule" className={select === 2 && "aSelect"} onClick={() => setSelect(2)}>
                        <FontAwesomeIcon icon={faList} /> Liste des Modules
                      </Link>
                    </li>
                  </ul>
                </nav>
