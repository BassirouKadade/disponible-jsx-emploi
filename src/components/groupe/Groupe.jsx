...
export default function Groupe({ etat }) {
            ...
            {!openMenu && (
              <>
                ...
                <nav className="salles-menu">
                  <ul>
                    <li>
                      <Link to="ajoutGroupe" className={select === 1 && "aSelect"} onClick={() => setSelect(1)}>
                        <FontAwesomeIcon icon={faPlusCircle} /> Ajout des Groupes
                      </Link>
                    </li>
                    <li>
                      <Link to="listeGroupe" className={select === 2 && "aSelect"} onClick={() => setSelect(2)}>
                        <FontAwesomeIcon icon={faList} /> Liste des Groupes
                      </Link>
                    </li>
                  </ul>
                </nav>
