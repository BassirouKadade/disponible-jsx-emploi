...
import { faPlusCircle, faRightToBracket,faExplosion, faHandPointLeft, faAngleRight, faList, faSearch, faClipboard, faChartBar } from '@fortawesome/free-solid-svg-icons';
            ...
            {!openMenu && (
              <>
                ...
                <nav className="salles-menu">
                  <ul>
                    <li>
                      <Link to="salle" className={select === 1 && "aSelect"} onClick={() => setSelect(1)}>
                        <FontAwesomeIcon icon={faPlusCircle} /> Ajout des Salles
                      </Link>
                    </li>
                    <li>
                      <Link to="listeSsalle" className={select === 2 && "aSelect"} onClick={() => setSelect(2)}>
                        <FontAwesomeIcon icon={faList} /> Liste des Salles
                      </Link>
                    </li>
                    <li>
                      <Link to="reservations" className={select === 4 && "aSelect"} onClick={() => setSelect(4)}>
                        <FontAwesomeIcon icon={faClipboard} /> Réservations
                      </Link>
                    </li>
                    <li>
                      <Link to="statistiques" className={select === 5 && "aSelect"} onClick={() => setSelect(5)}>
